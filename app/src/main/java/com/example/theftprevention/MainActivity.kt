...
import com.example.theftprevention.ShakeSensitivityActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var btnShakeSettings: Button
    ...
    private var shakeThreshold: Float = 1.0f // مقدار پیش‌فرض
    private lateinit var btnSoundSettings:Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnShakeSettings = findViewById(R.id.btnShakeSettings)
        ...
        shakeThreshold = sharedPreferences.getFloat("shake_threshold", 1.0f)
        ...
        btnShakeSettings.setOnClickListener {
            startActivity(Intent(this, ShakeSensitivityActivity::class.java))
        }
        btnSoundSettings.setOnClickListener {
            startActivity(Intent(this,SoundSelectionActivity::class.java))
        }
        ...
        shakeListener = object : SensorEventListener {
            override fun onSensorChanged(event: SensorEvent?) {
                event?.let {
                    ...
                    if (delta > shakeThreshold && shakeSwitch.isChecked) {
                        setMaxVolume()
    ...
    private fun sendLocationSms() {
        ...
        fusedLocationClient.lastLocation
            .addOnSuccessListener { location: Location? ->
                ...
                Log.e("LocationSMS", "Failed to get lastlocation", it)
            }
    }
